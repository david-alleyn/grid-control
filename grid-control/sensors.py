...
def populate_tree(treeWidget, start_silently):
    ...
    for component_key, component_nodelist in sensors_dict.items():
        ...
        component_qt_item.setFlags(QtCore.Qt.ItemFlag.ItemIsEnabled)  # Make hardware nodes "not selectable" in the UI
        ...
        for sensor_key, sensor_nodelist in component_nodelist.items():
            if sensor_key == 'Adapter':
                ...
                sensor_qt_item.setFlags(QtCore.Qt.ItemFlag.ItemIsEnabled)  # Make hardware nodes "not selectable" in the UI
                ...
                for sensor_param_key, sensor_param_nodelist in sensor_nodelist.items():
                    ...
                    sensor_param_qt_item.setForeground(0, QtGui.QBrush(QtCore.Qt.GlobalColor.blue))
                    sensor_param_qt_item.setForeground(2, QtGui.QBrush(QtCore.Qt.GlobalColor.blue))
